...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_gear'])) {
    ...
    $sql = "INSERT INTO riding_gears (name, description, price, stock, category, product_image, additional_images)
            VALUES ('$name', '$description', '$price', '$stock', '$category', '$product_image', '$additional_images')";

    if (mysqli_query($conn, $sql)) {
        echo "<div class='alert alert-success'>Riding gear added successfully.</div>";
    } else {
        echo "<div class='alert alert-danger'>Error adding riding gear: " . mysqli_error($conn) . "</div>";
    }
}
?>
...
<head>
    ...
    <title>Add Riding Gear</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="admin_style.css">
</head>
<body>
    <div class="container mt-4">
        <h1>Add Riding Gear</h1>
        <form action="riding_gears.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <button type="submit" name="add_gear" class="btn btn-primary">Add Gear</button>
        </form>
    </div>
</body>
</html>
