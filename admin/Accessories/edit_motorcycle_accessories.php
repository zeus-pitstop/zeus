...
// Fetch the accessory to edit if an ID is provided
$accessory = null;
if (isset($_GET['id'])) {
...
if (isset($_POST['delete_accessory'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: manage_accessories.php"); // Redirect to the management page
        exit();
    } else {
...
<head>
    ...
    <title>Edit Motorcycle Accessory</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="admin_style.css">
</head>
<body>
    <div class="container mt-4">
        <h1>Edit Motorcycle Accessory</h1>
        <?php if ($accessory): ?>
        <form action="edit_motorcycle_accessories.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="category" name="category" required>
                    ...
                    while ($row = mysqli_fetch_assoc($categories_result)) {
                        echo "<option value='" . htmlspecialchars($row['id']) . "'" . ($accessory['category_id'] == $row['id'] ? ' selected' : '') . ">" . htmlspecialchars($row['category_name']) . "</option>";
                    }
                    ?>
                </select>
            </div>
